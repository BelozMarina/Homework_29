...
public class SearchItemSteps {
    ...
    public void iWantToFollowThePageAs(String arg0)  {
        electronicsPageActions.clickOnSmartWatchesItem();
    }

    @Then("^I should see watches has brand \"([^\"]*)\"$")
    public void iShouldSeeWatchesHasBrand(String arg0) {
        electronicsPageActions.selectBrandSamsung();
    }
}
